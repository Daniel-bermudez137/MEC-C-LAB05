...
public class LeerArchivo {
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(archivo))) {
            ...
            // Definir ruta y nombre del archivo de la gráfica
            String archivoImagen = "nacimientos_por_departamento.jpeg";
            
            // Guardar la gráfica en formato JPEG
            ChartUtilities.saveChartAsJPEG(new File(archivoImagen), chart, 800, 600);
        } catch (IOException e) {
